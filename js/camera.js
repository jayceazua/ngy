...
;(function($){$.fn.camera = function(opts, callback) {
	...
	var defaults = {
		...
		prevButton			: "camera_prev", //Prev class
		
		nextButton			: "camera_next", //Next Class
		...
		paginationClass		: 'camera_pag', // Custom Pagination class
...
////////callbacks
	...
	if(opts.navigation==true){
		fakeHover.append(
			'<div class="'+ opts.prevButton +'"><i class="fa fa-chevron-left" aria-hidden="true"></i></div>'
			).append(
			'<div class="'+ opts.nextButton +'"><i class="fa fa-chevron-right" aria-hidden="true"></i></div>'
			);
	}
	...
	if(opts.pagination==true){
		wrap.append(
			'<div class="'+ opts.paginationClass +'"></div>'
			);
	}
	...
	var pieID = 'pie_'+wrap.index(),		
		...
		prevNav = $('.'+ opts.prevButton,wrap),
		nextNav = $('.'+ opts.nextButton,wrap),
		commands = $('.camera_commands',wrap),
		pagination = $('.'+ opts.paginationClass ,wrap),
	...
	function nextSlide(navSlide){ 
		...
		if(!$('.imgLoaded',slide).length){
			...
			$.each(arr, function(index, value) {
				...
				if($(pagination).length){
					$('.'+ opts.paginationClass +' li',wrap).removeClass('cameracurrent');
					$('.'+ opts.paginationClass +' li',wrap).eq(slideI).addClass('cameracurrent');
				}
				...
				if($(pagination).length){
					$('.'+ opts.paginationClass +' li',wrap).click(function(){
						if(!elem.hasClass('camerasliding')){
