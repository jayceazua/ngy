...
$link_name = "Add New Blog Tag";
$ms = round($_GET["id"], 0);
$status_id = 1;

if ($ms > 0){
	$sql="select * from tbl_blog_tag where id = '". $cm->filtertext($ms) ."'";
	...
	if ($found > 0){
		...
		$link_name = "Modify Existing Blog Tag";
	}else{
		$ms = 0;
	}
}
...
<form method="post" action="blog_tag_sub.php" id="tag_ff" name="ff" enctype="multipart/form-data">
    ...
    <tr>
          <td width="35%" align="left"><span class="fontcolor3">* </span>Tag Name:</td>
