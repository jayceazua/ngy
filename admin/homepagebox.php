...
<form method="post" action="homepagebox.php" name="ff" enctype="multipart/form-data">
		<input type="hidden" value="tbl_homepage_box" name="tblname" id="tblname" />
		...
		<table border="0" width="95%" cellspacing="0" cellpadding="0">		  
		  <tr>
		   ...
		   <table border="0" width="100%" cellspacing="1" cellpadding="4" class="htext">
			 ...
			 ?>     
			 <tr>  
                  <td class="displaytd1" align="center"><a href="add-homepage-box.php?id=<?php echo $id; ?>" title="Modify Record"><img alt="Modify Record" title="Modify Record" src="images/mod.gif"  class="imgcommon" /></a></td>
                  <td class="displaytd1" width="" align="left"><?php echo $name; ?></td>
                  <td class="displaytd1" width="" align="center"><?php if ($imagepath != ""){?><img src="../homeboximage/<?php echo $imagepath; ?>" border="0" width="100" /><?php }else{ ?> - <?php } ?></td>         
            </tr>			 
			 <?php
			  $rc_count++;
			 }
