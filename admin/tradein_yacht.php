...
$link_name = "Trade / Special Deals Boats";
            ...
            <form method="post" id="boatassign_ff" name="ff">
                <table border="0" width="100%" cellspacing="0" cellpadding="5" class="htext">
                    <tr>
                        ...
                        <td width="40%" align="left"><input type="text" id="keyterm" name="keyterm" value="" class="inputbox inputbox_size4" placeholder="Condition, Type, Make, Model, Year, Length, Broker" /></td>
...
<?php echo $yachtclass->display_boat_assigned_section_trade_in(); ?>
</div>
