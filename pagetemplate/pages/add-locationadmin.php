...
$old_status_id = 0;
$old_d_username = "";
$link_name = $atm1 = "Add Location Admin";
...
if ($ms > 0){
    ...
    if ($found > 0){
        ...
        $link_name = $atm1 = "Modify Location Admin";
    }else{
        $ms = 0;
    }
}
...
if ($company_id == 0 OR $company_id == ""){ $company_id = $com_id; }
...
?>
<form method="post" action="<?php echo $bdir; ?>locationadmin-sub.php" id="user_ff" name="ff" enctype="multipart/form-data">
