...
$link_name = "List Of Tender and Toy";
$pno = $_GET["pno"];
$s = round($_GET["s"], 0);
$sby = $_GET["sby"];
$ord = $_GET["ord"];
...
$sql = "select * from tbl_tendertoy where";
...
if ($admin_query_string != ""){
   $_SESSION["bck_pg"] = "mod-tendertoy.php?".$admin_query_string;
}else{
   $_SESSION["bck_pg"] = "mod-tendertoy.php";
}
...
<form method="get" action="mod-tendertoy.php" name="f1">
...
<form method="post" action="mod-tendertoy.php" name="ff" enctype="multipart/form-data">
		<input type="hidden" value="tbl_tendertoy" name="tblname" id="tblname" />
		...
		<table border="0" width="95%" cellspacing="0" cellpadding="0">		  
		  <tr>
		      <td width="330" align="left" valign="top"><a href="add-tendertoy.php" class="butta"><span class="addIcon butta-space">Add</span></a></td>
		  ...
		  <tr>
		   ...
		   <table border="0" width="100%" cellspacing="1" cellpadding="4" class="htext">
               <tr>
                   ...
                   <td class="displaytdheading" align="center">Icon</td>
			 ...
			 ?>     
			 <tr> 
                  <td class="displaytd1" align="center"><?php echo $adm->delete_record($id, 'tendertoy'); ?></td>
                  <td class="displaytd1" align="center"><a href="add-tendertoy.php?id=<?php echo $id; ?>" title="Modify Record"><img alt="Modify Record" title="Modify Record" src="images/mod.gif"  class="imgcommon" /></a></td>
                  <td class="displaytd1" width="" align="left"><?php echo $name; ?></td>
                  <td class="displaytd1" width="" align="center"><?php if ($iconpath != ""){?><img src="../charterboat/tendertoy/<?php echo $iconpath; ?>" border="0" width="50" /><?php }else{ ?> - <?php } ?></td>
                  <td class="displaytd1" align="center"><a class="htext" href="javascript:void(0);" onclick="javascript:enable_disable('<?php echo $id; ?>', 'status_id', 'tbl_tendertoy', '<?php echo $ch_opt; ?>', 'id')"><?php echo $status_d; ?></a></td>
