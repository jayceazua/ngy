...
$call_function = "a";
include("pageset.php");
$link_name = "List Of Blog Category";
...
$sql = "select * from tbl_blog_category where parent_id = '". $parentid ."' and";
...
if ($admin_query_string != ""){
   $_SESSION["bck_pg"] = "mod_blog_category.php?".$admin_query_string;
}else{
   $_SESSION["bck_pg"] = "mod_blog_category.php";
}
...
<form method="get" action="mod_blog_category.php" name="f1">
...
<?php if ($parentid > 0){ ?>
    <table border="0" cellspacing="0" cellpadding="0" width="95%">
        <tr>
            <td align="left">
                <div class="main_con">
                    <strong>Blog Category Path: </strong>
                    <?php
                    $brdcmp_array = array();
                    $arry_cnt = 0;
                    $brdcmp_array[$arry_cnt]["a_title"] = "Blog Category";
                    $brdcmp_array[$arry_cnt]["a_link"] = "mod_blog_category.php";
                    $arry_cnt++;

                    $catholder_ar = array();
                    $child_category_ar = $cm->collect_parent_category($parentid, $catholder_ar, 0);
                    ...
                    $cur_nm = $db->total_record_count("select name as ttl from tbl_blog_category where id = '". $parentid."'");
...
<form method="post" action="mod_blog_category.php" name="ff" enctype="multipart/form-data">
		<input type="hidden" value="tbl_blog_category" name="tblname" id="tblname" />
		<input type="hidden" value="<?php echo $found; ?>" name="t_found" id="t_found" />
		<table border="0" width="95%" cellspacing="0" cellpadding="0">
            <tr>
                  <td width="330" align="left" valign="top"><a href="add_blog_category.php?parentid=<?php echo $parentid;?>" class="butta"><span class="addIcon butta-space">Add</span></a></td>
        ...
        <?php
		$gotopagenm = "mod_blog_category.php";
		...
		<table border="0" width="95%" cellspacing="0" cellpadding="0">		  
		  <tr>
		   ...
		   <table border="0" width="100%" cellspacing="1" cellpadding="4" class="htext">
			 ...
			 ?>  
             <tr>
             	<td class="displaytd1" align="center"><?php echo $adm->delete_record($id, 'blogcategory'); ?></td>
                <td class="displaytd1" align="center"><a href="add_blog_category.php?id=<?php echo $id; ?>" title="Modify Record"><img alt="Modify Record" title="Modify Record" src="images/mod.gif"  class="imgcommon" /></a></td>
                <td class="displaytd1" width="" align="left"><?php echo $name; ?></td>
                <td class="displaytd1" width="" align="center">[fcbloglist categoryid=<?php echo $id; ?>]</td>
                <td class="displaytd1" align="center"><a class="htext" href="javascript:void(0);" onclick="javascript:enable_disable('<?php echo $id; ?>', 'status_id', 'tbl_blog_category', '<?php echo $ch_opt; ?>', 'id')"><?php echo $status_d; ?></a></td>
