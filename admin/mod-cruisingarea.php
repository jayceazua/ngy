...
$link_name = "List Of Cruising Area";
$pno = $_GET["pno"];
$s = round($_GET["s"], 0);
$sby = $_GET["sby"];
$ord = $_GET["ord"];
...
$sql = "select * from tbl_cruisingarea where";
...
if ($admin_query_string != ""){
   $_SESSION["bck_pg"] = "mod-cruisingarea.php?".$admin_query_string;
}else{
   $_SESSION["bck_pg"] = "mod-cruisingarea.php";
}
...
<form method="get" action="mod-cruisingarea.php" name="f1">
...
<form method="post" action="mod-cruisingarea.php" name="ff" enctype="multipart/form-data">
		<input type="hidden" value="tbl_cruisingarea" name="tblname" id="tblname" />
		...
		<table border="0" width="95%" cellspacing="0" cellpadding="0">		  
		  <tr>
		      <td width="330" align="left" valign="top"><a href="add-cruisingarea.php" class="butta"><span class="addIcon butta-space">Add</span></a></td>
        ...
        <?php
		$gotopagenm = "mod-cruisingarea.php";
		  ...
		  <tr>
		   ...
		   <table border="0" width="100%" cellspacing="1" cellpadding="4" class="htext">
               <tr>
                   ...
                   <td class="displaytdheading" width="60%" align="left">Name</td>
			 ...
			 ?>     
			 <tr> 
                  <td class="displaytd1" align="center"><?php echo $adm->delete_record($id, 'cruisingarea'); ?></td>
                  <td class="displaytd1" align="center"><a href="add-cruisingarea.php?id=<?php echo $id; ?>" title="Modify Record"><img alt="Modify Record" title="Modify Record" src="images/mod.gif"  class="imgcommon" /></a></td>
                  <td class="displaytd1" width="" align="left"><?php echo $name; ?></td>
                  <td class="displaytd1" align="center"><a class="htext" href="javascript:void(0);" onclick="javascript:enable_disable('<?php echo $id; ?>', 'status_id', 'tbl_cruisingarea', '<?php echo $ch_opt; ?>', 'id')"><?php echo $status_d; ?></a></td>
