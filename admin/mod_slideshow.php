...
$sql = "select * from tbl_boat_slideshow where";
...
if ($admin_query_string != ""){
   $_SESSION["bck_pg"] = "mod_slideshow.php?".$admin_query_string;
}else{
   $_SESSION["bck_pg"] = "mod_slideshow.php";
}
...
<form method="get" action="mod_slideshow.php" name="f1">
...
<form method="post" action="mod_slideshow.php" name="ff" enctype="multipart/form-data">
		<input type="hidden" value="tbl_boat_slideshow" name="tblname" id="tblname" />
		<input type="hidden" value="<?php echo $found; ?>" name="t_found" id="t_found" />
		<table border="0" width="95%" cellspacing="0" cellpadding="0">
            <tr>
                  <td width="330" align="left" valign="top"><a href="add_slideshow.php" class="butta"><span class="addIcon butta-space">Add</span></a></td>
		  ...
		  <tr>
		   ...
		   <table border="0" width="100%" cellspacing="1" cellpadding="4" class="htext">
                <tr>
                    ...
                    <td class="displaytdheading" width="30%" align="left">Name</td>
                    <td class="displaytdheading" width="30%" align="center" nowrap="nowrap">URL</td>
             ...
             foreach($result as $row){
				 ...
				 $sl_url = $cm->get_page_url($slug, "boatslideshow");
			 ?>  
             <tr>
             	<td class="displaytd1" align="center"><?php echo $adm->delete_record($id, 'slideshow'); ?></td>
                <td class="displaytd1" align="center">
                <a href="add_slideshow.php?id=<?php echo $id; ?>" title="Modify Record"><img alt="Modify Record" title="Modify Record" src="images/mod.gif"  class="imgcommon" /></a>
                <a href="assign-boat-slideshow.php?slideshow_id=<?php echo $id; ?>" title="Assign Boat"><img alt="Assign Boat" title="Assign Boat" src="images/work.gif"  class="imgcommon" /></a>
                </td>
                <td class="displaytd1" width="" align="left"><?php echo $name; ?></td>
                <td class="displaytd1" width="" align="center"><a href="<?php echo $sl_url; ?>" target="_blank" class="htext"><?php echo $sl_url; ?></a></td>
                <td class="displaytd1" align="center"><a class="htext" href="javascript:void(0);" onclick="javascript:enable_disable('<?php echo $id; ?>', 'status_id', 'tbl_boat_slideshow', '<?php echo $ch_opt; ?>', 'id')"><?php echo $status_d; ?></a></td>
