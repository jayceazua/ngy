...
//Meta
$final_meta = $yachtclass->collect_meta_info_boat($m1, $m2, $m3, $manufacturer_name, $model, $year, $length, $overview, $company_id);
$atm1 = $final_meta->m1;
$atm2 = $final_meta->m2;
$atm3 = $final_meta->m3;
...
?>
    ...
    <div class="left-cell">
        ...
        <div class="social righticoncol">
            <ul>            
                <li><a href="<?php echo $cm->folder_for_seo;?>?fcapi=createyachtpdf&lno=<?php echo $listing_no; ?>" title="Create a Brochure"><img src="<?php echo $bdir;?>images/print.png" alt=""></a></li>
    ...
    <div class="right-cell scrollcol" parentdiv="product-detail">
        ...
        <?php echo $yachtclass->display_company_location_details(array("company_id" => $company_id, "sidebar" => 1)); ?>
        </section>
		<?php
		}
		?>
