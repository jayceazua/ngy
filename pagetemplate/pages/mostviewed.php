    ...
    <div class="header-bottom-inner clearfixmain">
        <ul class="form">
            <li>
                ...
                <div class="s_button1"><a class="filterrecord active" fsection="1" href="javascript:void(0);" title="Filter"><img src="<?php echo $cm->folder_for_seo;?>images/search.png" /></a></div>
            </li>
        </ul>
    </div>
</div>
...
<div id="filtersection" class="mostviewed">
    <?php
    $p = 1;
    $retval = json_decode($yachtclass->most_viewed_yacht($p, $loggedin_member_id, 0, 0));
    echo $retval[0]->doc;
    ?>
    <div class="clear"></div>
</div>
